...
class CommentServiceTest {
	...
	void deleteShouldDeleteChildOnlyIfNotDeletedParent() {
		...
		given(parentComment.getDeleted()).willReturn(false); // 상위 댓글은 삭제 안된 상태.
	...
	void deleteShouldDeleteAllRecursivelyIfDeletedParent() {
		...
		given(parentComment.getDeleted()).willReturn(true); // parent entity 는 삭제된 상태
	...
	void deleteNoParentNoChildrenComment() {
		...
		given(comment.getDeleted()).willReturn(false); // false가 기본 .
